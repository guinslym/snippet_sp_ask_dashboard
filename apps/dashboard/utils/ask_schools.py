...
sp_ask_school_dict = [
    ...
    },
    {
        "school": {
            "id": 5,
            "queues": ["tmu", "tmu-proactive", "tmu-txt"],
            "suffix": ["_tmu"],
            "short_name": "TMU",
            "full_name": "Toronto Metropolitan University",
        }
    },
    {
        "school": {
    ...
    },
    {
        "school": {
            "id": 7,
            "queues": ["queens", "queens-proactive", "queens-txt"],
            "suffix": ["_queens"],
            "short_name": "Queen's",
...
def find_school_by_operator_suffix(username):
    ...
    if "_" in username:
        ...
        return school
    elif "guelph-librarian1" == username:
        return "Guelph"
    elif "lakehead-librarian1" == username:
        return "lakehead"
    elif "sp-demo" == username:
...
def find_school_abbr_by_queue_or_profile_name(queue):
    ...
    Arguments:
        queue {str} -- queue/service i.e. tmu-proactive
