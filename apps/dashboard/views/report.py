...
from sp_ask_school import (find_queues_from_a_school_name,
...
from apps.dashboard.utils.utils import (Chats, helper_for_operator_assignments,
        ...
        reference_questions.append(
            {
                ...
                "Chat wait time (sec)": str(wait), 
                "Chat duration": str(ob_chat.duration), 
                "Chat Protocol": ob_chat.protocol, 
                "Chat started": str(ob_chat.started), 
                "Chat ended": str(ended), 
